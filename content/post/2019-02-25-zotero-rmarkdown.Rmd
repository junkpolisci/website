...
Once all of this is done you are ready to cite. You can see the minimal function version on my [GitHub page](https://github.com/junkpolisci) which is in my Website repository titled ["Test_Citation.Rmd"](https://github.com/junkpolisci/website/tree/master/content/blog).
